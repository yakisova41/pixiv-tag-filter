...
const IllustItemLike = ({
  ...
  return (
    <div className={"illust_item_like_outer"}>
      <div>
        <button className={"illust_item_likebtn"} onClick={handleClick}>
          <svg
            viewBox="0 0 32 32"
            width="32"
            height="32"
            className={
              "illust_item_likebtn_svg" +
              " " +
              (islike ? "illust_item_likebtn_svg_liked" : "")
            }
          >
            ...
            <path
              ...
              className={
                "illust_item_likebtn_svg_inner" +
                " " +
                (islike ? "illust_item_likebtn_svg_inner_liked" : "")
              }
            ></path>
          </svg>
        </button>
