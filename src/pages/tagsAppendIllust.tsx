...
export default ({
  ...
  illust.setAttribute(
    "style",
    "margin:0px;display:list-item;text-align:-webkit-match-parent;list-style:none;"
  );
    ...
    <div className={styles.jDiQFZ}>
      <div className={styles.hYfnPb}>
        <div className={styles.fxGVAF}>
          ...
          <div className={styles.eDNlMk}>
            <div>
              <button className={styles.fgVkZi} id="bookmarkBtn">
                <svg
                  className={styles.dxYRhf}
                  id="bookmarkSvg"
                  width="32"
                  height="32"
                >
                  ...
                  <path
                    d="M16,11.3317089 C15.0857201,9.28334665 13.0491506,7.5 11,7.5
                    ...
                    className={styles.dUurgf + " " + styles.whitebokuma}
                  ></path>
                </svg>
              </button>
            </div>
      ...
      <div className={styles.jtpclu}>
        <div className={styles.icsUdQ}>
          ...
          <a href={createrpage} className={styles.kghgsn}>
            {creatername}
          </a>
        </div>
      </div>
  ...
  illust.innerHTML = html;
  parent.appendChild(illust);
